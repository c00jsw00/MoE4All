...
//! `docs/diffusion-gemma.md` and `docs/qwen35.md`) — every arch, including DiffusionGemma, is built
...
pub use infr_chat::{
    ...
    ChatMessage, ChatTemplateOptions, TemplateError, ToolCall, IMAGE_PART_PLACEHOLDER,
};
