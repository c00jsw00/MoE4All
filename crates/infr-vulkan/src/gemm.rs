...
const ATTN_FLASH_REG_HD256_BR64_CW4_SPV_BYTES: &[u8] = include_bytes!(concat!(
    env!("OUT_DIR"),
    "/attn_flash_reg_hd256_br64_cw4.spv"
));
const ATTN_FLASH_REG_HD256_BR128_F16SCORE_SPV_BYTES: &[u8] = include_bytes!(concat!(
    env!("OUT_DIR"),
    "/attn_flash_reg_hd256_br128_f16score.spv"
));
const ATTN_FLASH_REG_HD256_BR128_F16SCORE_QK4_SPV_BYTES: &[u8] = include_bytes!(concat!(
    env!("OUT_DIR"),
    "/attn_flash_reg_hd256_br128_f16score_qk4.spv"
));
...
const ATTN_FLASH_REG_HD256_BR64_CW4_BDA_SPV_BYTES: &[u8] = include_bytes!(concat!(
    env!("OUT_DIR"),
    "/attn_flash_reg_hd256_br64_cw4_bda.spv"
));
...
static ATTN_FLASH_REG_HD256_BR64_CW4_SPV: OnceLock<Vec<u32>> = OnceLock::new();
static ATTN_FLASH_REG_HD256_BR128_F16SCORE_SPV: OnceLock<Vec<u32>> = OnceLock::new();
static ATTN_FLASH_REG_HD256_BR128_F16SCORE_QK4_SPV: OnceLock<Vec<u32>> = OnceLock::new();
...
static ATTN_FLASH_REG_HD256_BR64_CW4_BDA_SPV: OnceLock<Vec<u32>> = OnceLock::new();
...
#[cfg_attr(infr_profile, infr_prof::instrument)]
pub(crate) fn attn_flash_reg_hd256_br64_cw4_spv() -> &'static [u32] {
    ATTN_FLASH_REG_HD256_BR64_CW4_SPV
        .get_or_init(|| spv_words(ATTN_FLASH_REG_HD256_BR64_CW4_SPV_BYTES))
}

#[cfg_attr(infr_profile, infr_prof::instrument)]
pub(crate) fn attn_flash_reg_hd256_br128_f16score_spv() -> &'static [u32] {
    ATTN_FLASH_REG_HD256_BR128_F16SCORE_SPV
        .get_or_init(|| spv_words(ATTN_FLASH_REG_HD256_BR128_F16SCORE_SPV_BYTES))
}
#[cfg_attr(infr_profile, infr_prof::instrument)]
pub(crate) fn attn_flash_reg_hd256_br128_f16score_qk4_spv() -> &'static [u32] {
    ATTN_FLASH_REG_HD256_BR128_F16SCORE_QK4_SPV
        .get_or_init(|| spv_words(ATTN_FLASH_REG_HD256_BR128_F16SCORE_QK4_SPV_BYTES))
}
#[cfg_attr(infr_profile, infr_prof::instrument)]
...
#[cfg_attr(infr_profile, infr_prof::instrument)]
pub(crate) fn attn_flash_reg_hd256_br64_cw4_bda_spv() -> &'static [u32] {
    ATTN_FLASH_REG_HD256_BR64_CW4_BDA_SPV
        .get_or_init(|| spv_words(ATTN_FLASH_REG_HD256_BR64_CW4_BDA_SPV_BYTES))
}
...
/// SPIR-V for Qwen3.8's scaled SiLU bottleneck.
pub(crate) fn silu_scale_spv() -> &'static [u32] {
    static S: OnceLock<Vec<u32>> = OnceLock::new();
...
#[cfg_attr(infr_profile, infr_prof::instrument)]
pub(crate) fn qsa_indexer_score_spv() -> &'static [u32] {
    static S: OnceLock<Vec<u32>> = OnceLock::new();
    S.get_or_init(|| {
        spv_words(include_bytes!(concat!(
            env!("OUT_DIR"),
...
dyn_spv!(
    attn_decode_hd256_q8_ls256_qkf16_spv,
    "attn_decode_hd256_q8_ls256_qkf16"
);
...
pub(crate) fn attn_decode_q8_kernel(
    ...
    match (hd, swa, dynac) {
        ...
        (256, false, false) if d8 && ls256 && qk_f16 && pv_f16 => {
            Some(("attn_decode_hd256_q8_c512", attn_decode_hd256_q8_c512_spv()))
        }
        (256, false, false) if d8 && ls256 && qk_f16 => Some((
            "attn_decode_hd256_q8_ls256_qkf16",
            attn_decode_hd256_q8_ls256_qkf16_spv(),
        )),
        ...
        (256, false, false) if d8 => {
            Some(("attn_decode_hd256_q8_ls64", attn_decode_hd256_q8_ls64_spv()))
        }
        (256, false, false) => Some(("attn_decode_hd256_q8_d32", attn_decode_hd256_q8_d32_spv())),
        _ => None,
    }
}
