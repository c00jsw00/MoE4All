...
fn main() {
    ...
    let builds: &[(&str, &str, &[&str])] = &[
        ...
        (
            ...
            &["-DDHD4=64", "-DKVQ8", "-DKVQ8_D8", "-DLS256", "-DQK_F16"],
        ),
        (
            "attn_decode",
            "attn_decode_hd256_q8_d32",
            &["-DDHD4=64", "-DKVQ8"],
        ),
        (
            "attn_decode",
        ...
        (
            ...
            &["-DHEAD_DIM=256", "-DBR_TILE=128", "-DF16_SCORE"],
        ),
        (
            "attn_flash_reg",
        ...
        ("hyper_mix_gates_decode", "hyper_mix_gates_decode", &[]),
        ("hyper_pre", "hyper_pre", &[]),
        ...
        ("add_bias", "add_bias", &[]),
        ("mul_vec", "mul_vec", &[]),
        ("headwise_sigmoid_mul", "headwise_sigmoid_mul", &[]),
